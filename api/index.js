...
var discountTypeEnum = pgEnum("discount_type", ["percentage", "flat"]);
...
var salesRouter = createRouter({
  ...
  create: authedQuery.input(
    z4.object({
      ...
      discountType: z4.enum(["percentage", "flat"]).optional().default("flat"),
      discountValue: z4.number().optional().default(0),
    ...
    const [row] = await db.insert(sales).values({
      ...
      discountValue: input.discountValue?.toString() || "0",
  ...
  update: authedQuery.input(
    z4.object({
      ...
      totalAmount: z4.number(),
      discountType: z4.enum(["percentage", "flat"]).optional(),
      discountValue: z4.number().optional(),
  ...
  sales: {
    ...
    create: authedQuery.input(
      z6.object({
        ...
        discountType: z6.enum(["percentage", "flat"]).optional().default("flat"),
        discountValue: z6.number().optional().default(0),
    ...
    update: authedQuery.input(
      z6.object({
        ...
        servicesTotal: z6.number(),
        totalAmount: z6.number(),
        discountType: z6.enum(["percentage", "flat"]).optional(),
