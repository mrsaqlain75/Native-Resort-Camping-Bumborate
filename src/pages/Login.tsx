    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)] px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-in fade-in slide-in-from-top-4 duration-500">
          <div className="h-16 w-16 rounded-2xl bg-[var(--primary)] flex items-center justify-center mx-auto mb-5 shadow-card">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 339 328" className="w-11 h-11">
          ...
          <h1 className="font-serif text-[1.7rem] font-semibold text-[var(--foreground)]">Native Camping and Restaurant</h1>
          <p className="text-sm text-[var(--muted-foreground)] mt-1.5">Guides · Cuisines · Events · Bumburet</p>
        </div>

        <Card className="shadow-card animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              {error && (
                <div className="text-sm text-[var(--negative)] bg-[var(--destructive)]/10 border border-[var(--destructive)]/20 p-3 rounded-lg animate-in fade-in duration-300">
                  {error}
                </div>
              )}
