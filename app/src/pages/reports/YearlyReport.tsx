...
export default function YearlyReport() {
  ...
  const handleExport = () => {
    exportToExcel(chartData, `Yearly_Report_${year}.xlsx`);
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-[var(--muted-foreground)]">Month-by-month analysis for {year}</p>
        </div>
      ...
      <Card>
        <CardHeader><CardTitle className="text-lg font-serif">Annual Overview</CardTitle></CardHeader>
        <CardContent>
